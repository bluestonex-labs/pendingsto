		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Pending STO",
									"targetURL": "#woszintpendingsto-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"woszintpendingsto-display": {
								"semanticObject": "woszintpendingsto",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=wos.zint.pendingsto",
									"url": sap.ui.require.toUrl("wos/zint/pendingsto")
								}
							}
						}
					}
