...
function buildObjectMap(parserOutput) {
    ...
    parserOutput.schema.typeDefinitions.forEach(function (typeDefinition) {
...
function convertTypes(parserOutput) {
    ...
    var extraReferences = parserOutput.references.filter(function (reference) {
        return exports.defaultReferences.find(function (defaultRef) { return defaultRef.namespace === reference.namespace; }) === undefined;
    });
    var convertedOutput = {
        ...
        typeDefinitions: parserOutput.schema.typeDefinitions,
        references: exports.defaultReferences.concat(extraReferences),
...
function revertValueToGenericType(references, value) {
    ...
    if (typeof value === "string") {
        ...
        var valueMatches_2 = value.match(/(\w+)\.\w+\/.*/);
        if (valueMatches_2 && references.find(function (ref) { return ref.alias === valueMatches_2[1]; })) {
            result = {
                type: "EnumMember",
...
function parseTypeDefinitions(typeDefinitions, annotationLists, namespace) {
...
function parseSchema(edmSchema, identification) {
    ...
    const typeDefinitions = parseTypeDefinitions(utils_1.ensureArray(edmSchema.TypeDefinition), annotations, namespace);
    let entitySets = [];
    let singletons = [];
    let associationSets = [];
    let entityContainer = {};
...
function mergeSchemas(schemas) {
    ...
    const typeDefinitions = schemas.reduce((typeDefinitions, schema) => {
...
function mockAnswer(app, serverInit) {
...
function createMockMiddleware(inConfig, basePath) {
    var _this = this;
    var app = router_1.default();
    var log = logger_1.getLogger('server:ux-fe-mockserver');
    app.use(disableCache);
    var newConfig = configResolver_1.resolveConfig(inConfig, basePath);
    if (newConfig.watch) {
        log.info("Mockserver is running in watch mode");
    }
    var oDataHandlerPromises = newConfig.services.map(function (mockService) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var _loop_1 = function (mockAnnotation) {
        app.get(escapeRegex(mockAnnotation.urlPath), function (req, res) {
            return fileLoader_1.loadFile(mockAnnotation.localPath)
                .then(function (data) {
    ...
    for (var _i = 0, _a = newConfig.annotations; _i < _a.length; _i++) {
        var mockAnnotation = _a[_i];
        _loop_1(mockAnnotation);
    }
    var serverInit = Promise.all(oDataHandlerPromises);
    if (fileLoader_1.isInBrowser()) {
        // eslint-disable-next-line @typescript-eslint/no-var-requires
        var nise_1 = __webpack_require__(3255);
        var fakeServer = nise_1.fakeServer;
        var escapePath_1 = function (sPath) {
            // eslint-disable-next-line
            return sPath.replace(/[\\\/\[\]\{\}\(\)\-\*\+\?\.\^\$\|]/g, '\\$&');
        };
        nise_1.fakeXhr.FakeXMLHttpRequest.useFilters = true;
        var mockServer_1 = fakeServer.create();
        mockServer_1.autoRespond = true;
        newConfig.services.forEach(function (newService) {
            ...
            mockServer_1.respondWith(serverhook, browserMiddleware_1.mockAnswer(app, serverInit));
        });
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 5:
                            _c.sent();
                            part.response = odataReq.createResponse(null, false, undefined, true);
                            return [3 /*break*/, 16];
                        case 6:
...
var DataAccess = /** @class */ (function () {
    ...
    function DataAccess(root, metadata, strictKeyMode, contextBasedIsolation, generateMockData, debugMode) {
        ...
        this.metadata.getSingletons().forEach(function (entitySet) {
            _this.getMockEntitySet(entitySet.name, generateMockData);
        });
    }
    ...
    DataAccess.prototype.getMockEntitySet = function (entityTypeName, generateMockData, containedEntityType, containedData) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var mockEntitySet, entitySet, singleton, entityType, mockEntitySet;
            return __generator(this, function (_b) {
                if (containedEntityType) {
                    ...
                    singleton = this.metadata.getSingleton(entityTypeName);
     ...
     * @param forCreate
     */
    DataAccess.prototype.getNavigationPropertyKeys = function (data, navPropDetail, currentEntityType, currentEntitySet, currentKeys, forCreate) {
        ...
        if (navPropDetail.referentialConstraint && navPropDetail.referentialConstraint.length > 0) {
            ...
            dataArray.forEach(function (data) {
                ...
                if (currentEntitySet &&
                    data.hasOwnProperty('IsActiveEntity') &&
                    (((_c = (_b = (_a = currentEntitySet.navigationPropertyBinding[navPropDetail.name]) === null || _a === void 0 ? void 0 : _a.annotations) === null || _b === void 0 ? void 0 : _b.Common) === null || _c === void 0 ? void 0 : _c.DraftNode) ||
                        ((_f = (_e = (_d = currentEntitySet.navigationPropertyBinding[navPropDetail.name]) === null || _d === void 0 ? void 0 : _d.annotations) === null || _e === void 0 ? void 0 : _e.Common) === null || _f === void 0 ? void 0 : _f.DraftRoot))) {
                    currentKeys['IsActiveEntity'] = data.IsActiveEntity;
                }
                if (data.hasOwnProperty('IsActiveEntity') &&
                    (((_h = (_g = navPropDetail.targetType.annotations) === null || _g === void 0 ? void 0 : _g.Common) === null || _h === void 0 ? void 0 : _h.DraftNode) ||
                        ((_k = (_j = navPropDetail.targetType.annotations) === null || _j === void 0 ? void 0 : _j.Common) === null || _k === void 0 ? void 0 : _k.DraftRoot))) {
                    currentKeys['IsActiveEntity'] = data.IsActiveEntity;
                }
            });
        }
                    ...
                    case 1:
                        ...
                        _loop_2 = function (data_1) {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        currentKeys = this_1.getNavigationPropertyKeys(data_1, navProp, entityType, targetEntitySet, {});
    ...
    DataAccess.prototype.getData = function (odataRequest, dontClone) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var currentEntitySet, previousEntitySet, currentEntityType, returnPropertyType, visitedPaths, targetContainedData, targetContainedEntityType, rootEntitySet, isCount, data, newData, potentialTarget, filterDef_1, mockEntitySet_1, mockEntitySet_2, dataByGroup_1, mockEntitySet, mockData_1, getAggregateKey_1, originalData_2, apply$Select_1, select_1, expand, enrichElement_2;
            var _this = this;
            return __generator(this, function (_r) {
                switch (_r.label) {
                    case 0:
                        ...
                        returnPropertyType = null;
                        visitedPaths = [];
                        targetContainedEntityType = null;
                        rootEntitySet = this.metadata.getEntitySet(odataRequest.query.queryPath[0].path);
                        //let isSingleton = false;
                        if (!rootEntitySet) {
                            rootEntitySet = this.metadata.getSingleton(odataRequest.query.queryPath[0].path);
                            //isSingleton = true;
                        }
                        isCount = false;
                        return [4 /*yield*/, odataRequest.query.queryPath.reduce(function (data, queryPathPart, index) { return __awaiter(_this, void 0, void 0, function () {
                                var currentKeys, asArray, navPropDetail, navPropDetail, hasOnlyDraftKey, propDetail;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                            ...
                                            if (!currentEntityType) {
                                                ...
                                                if (navPropDetail) {
                                                    if (navPropDetail.name === 'SiblingEntity' && currentEntityType) {
                                                        asArray = asArray && navPropDetail.isCollection;
                                                        currentKeys = this.metadata.getKeys(data, currentEntityType);
                                                        currentKeys.IsActiveEntity = !data.IsActiveEntity;
                                                    }
                                                    else {
                                                        ...
                                                        if (navPropDetail) {
                                                            if (asArray) {
                                                                currentKeys = this.getNavigationPropertyKeys(data, navPropDetail, currentEntityType, currentEntitySet, currentKeys);
                                                            }
                                                    ...
                                                    propDetail = currentEntityType.entityProperties.find(function (navProp) { return navProp.name === queryPathPart.path; });
                                                    if (propDetail) {
                                        ...
                                        case 2: return [2 /*return*/, (_a.sent()).performGET(currentKeys, asArray, odataRequest.tenantId, dontClone, odataRequest)];
                                    }
                                });
                            }); }, {})];
                    case 1:
                        ...
                        if (returnPropertyType) {
                            if (((_a = returnPropertyType === null || returnPropertyType === void 0 ? void 0 : returnPropertyType.targetType) === null || _a === void 0 ? void 0 : _a._type) === 'ComplexType') {
                                newData = lodash_clonedeep_1.default(data);
                    ...
                    case 2:
                        ...
                        _r.label = 3;
                    case 3:
                        if (!((odataRequest.query.filter || ((_g = (_f = odataRequest.query) === null || _f === void 0 ? void 0 : _f.aggregateDefinition) === null || _g === void 0 ? void 0 : _g.filter)) && Array.isArray(data))) return [3 /*break*/, 5];
                        filterDef_1 = odataRequest.query.filter || ((_j = (_h = odataRequest.query) === null || _h === void 0 ? void 0 : _h.aggregateDefinition) === null || _j === void 0 ? void 0 : _j.filter);
                        return [4 /*yield*/, this.getMockEntitySet(currentEntitySet ? currentEntitySet.name : currentEntityType.name)];
                    case 4:
                        mockEntitySet_1 = _r.sent();
                    ...
                    case 11:
                        // Apply $orderby
                        if (((_k = odataRequest === null || odataRequest === void 0 ? void 0 : odataRequest.query) === null || _k === void 0 ? void 0 : _k.orderBy) && ((_l = odataRequest === null || odataRequest === void 0 ? void 0 : odataRequest.query) === null || _l === void 0 ? void 0 : _l.orderBy.length) > 0) {
                        ...
                        if ((_m = odataRequest === null || odataRequest === void 0 ? void 0 : odataRequest.query) === null || _m === void 0 ? void 0 : _m.properties) {
                        ...
                        if (((_o = odataRequest === null || odataRequest === void 0 ? void 0 : odataRequest.query) === null || _o === void 0 ? void 0 : _o.properties) && Object.keys((_p = odataRequest === null || odataRequest === void 0 ? void 0 : odataRequest.query) === null || _p === void 0 ? void 0 : _p.properties).length > 0) {
                            apply$Select_1 = function (expand, data) {
                                ...
                                allNavProps = allNavProps.filter(function (navPropName) { return navPropName !== 'DraftAdministrativeData'; });
                            ...
                            expand = {
                                expand: (_q = odataRequest.query.expand) !== null && _q !== void 0 ? _q : {},
                                select: select_1
                            };
                            if (Array.isArray(data)) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        currentKeys_1 = this.getNavigationPropertyKeys(data, navPropDetail, entitySet.entityType, entitySet, providedKeys_1, true);
                            ...
                            return __generator(this, function (_g) {
                                switch (_g.label) {
                                    case 0:
                                        ...
                                        subKeys = this_1.dataAccess.getNavigationPropertyKeys(data, navPropDetail, this_1.entitySetDefinition.entityType, this_1.entitySetDefinition, {});
                            ...
                            return __generator(this, function (_h) {
                                switch (_h.label) {
                                    case 0:
                                        ...
                                        subKeys = this_2.dataAccess.getNavigationPropertyKeys(draftData, navPropDetail, this_2.entitySetDefinition.entityType, this_2.entitySetDefinition, {});
                            ...
                            return __generator(this, function (_f) {
                                switch (_f.label) {
                                    case 0:
                                        ...
                                        subKeys = this_3.dataAccess.getNavigationPropertyKeys(data, navPropDetail, this_3.entitySetDefinition.entityType, this_3.entitySetDefinition, {});
                            ...
                            return __generator(this, function (_f) {
                                switch (_f.label) {
                                    case 0:
                                        ...
                                        subKeys = this_4.dataAccess.getNavigationPropertyKeys(draftData, navPropDetail, this_4.entitySetDefinition.entityType, this_4.entitySetDefinition, {});
                            ...
                            return __generator(this, function (_h) {
                                switch (_h.label) {
                                    case 0:
                                        ...
                                        subKeys = this_5.dataAccess.getNavigationPropertyKeys(data, navPropDetail, this_5.entitySetDefinition.entityType, this_5.entitySetDefinition, {});
                            ...
                            return __generator(this, function (_g) {
                                switch (_g.label) {
                                    case 0:
                                        ...
                                        subKeys = this_6.dataAccess.getNavigationPropertyKeys(draftData, navPropDetail, this_6.entitySetDefinition.entityType, this_6.entitySetDefinition, {});
...
var MockDataEntitySet = /** @class */ (function () {
     ...
     * @param dontClone
     */
    MockDataEntitySet.prototype.performGET = function (keyValues, asArray, tenantId, dontClone, odataRequest) {
        var _a, _b, _c, _d, _e, _f;
        if (dontClone === void 0) { dontClone = false; }
        var currentMockData = this.getMockData(tenantId);
...
var ODataMetadata = /** @class */ (function () {
     ...
     */
    function ODataMetadata(metadata, parserMetadata, metadataUrl, ETag) {
     ...
     * @param edmx
     */
    ODataMetadata.parse = function (edmx, metadataUrl, ETag) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, new ODataMetadata(converterMetadata, metadata, metadataUrl, ETag)];
            });
        });
    };
    ODataMetadata.prototype.getMetadataUrl = function () {
    ...
    ODataMetadata.prototype.getSingleton = function (singletonName) {
        return this.metadata.singletons.find(function (singleton) { return singleton.name === singletonName; });
    };
    /**
     *
     */
    ...
    ODataMetadata.prototype.getSingletons = function () {
    ...
    ODataMetadata.prototype.resolveDraftRoot = function (entitySet) {
        ...
        var foundPath;
        var rootEntitySet;
        this.metadata.entitySets.forEach(function (et) {
    ...
    ODataMetadata.prototype.getETag = function () {
        return this.ETag;
    };
    ODataMetadata.prototype.getKeys = function (dataLine, entityType) {
...
var StickyMockEntitySet = /** @class */ (function (_super) {
    ...
    StickyMockEntitySet.prototype.executeAction = function (actionDefinition, actionData, odataRequest, keys) {
        return __awaiter(this, void 0, void 0, function () {
            var currentMockData, responseObject, _a, data, duplicate, newObject_1, nonNullableProperties, newData;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        currentMockData = this.getMockData(odataRequest.tenantId);
     ...
     * @param odataRequest
     */
    StickyMockEntitySet.prototype.addSessionToken = function (odataRequest) {
        var uuid = id_1.generateId(16);
        this.currentUUID = uuid;
        odataRequest.setResponseHeader('sap-contextid', 'SID:ANON:' + uuid);
     ...
     * @param dontClone
     */
    StickyMockEntitySet.prototype.performGET = function (keyValues, asArray, tenantId, dontClone, odataRequest) {
        if (dontClone === void 0) { dontClone = false; }
        ...
        if (currentSessionObject && keyValues && Object.keys(keyValues).length) {
            if ((Object.prototype.hasOwnProperty.call(keyValues, "''") && keyValues["''"] === undefined) ||
                ...
                if (odataRequest) {
                    odataRequest.setResponseHeader('sap-contextid', 'SID:ANON:' + this.currentUUID);
            ...
            switch (_a.label) {
                ...
                case 6:
                    if (!fileLoader_1.isInBrowser() && !service.noETag) {
                        service.ETag = etag_1.default(edmx, { weak: true });
                    }
                    return [4 /*yield*/, metadata_1.ODataMetadata.parse(edmx, service.urlPath + '/$metadata', service.ETag)];
                case 7:
                    metadata = _a.sent();
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 4:
                                        edmx = _a.sent();
                                        _a.label = 5;
                                    case 5: return [4 /*yield*/, metadata_1.ODataMetadata.parse(edmx, service.urlPath + '/$metadata', service.ETag)];
                                    case 6:
                                        metadata = _a.sent();
                ...
                case 9:
                    ...
                    router.use('*', function (err, req, res, next) {
                        ...
                        if (err instanceof simpleHttpResponse_1.SimpleResponse && res) {
...
var ODataRequest = /** @class */ (function () {
     ...
     * @param key
     */
    ODataRequest.prototype.createResponse = function (data, bCreated, key, bDeleted) {
        if (bCreated === void 0) { bCreated = false; }
        if (key === void 0) { key = undefined; }
        if (bDeleted === void 0) { bDeleted = false; }
        var response = new simpleHttpResponse_1.SimpleResponse();
        if (data !== null) {
...
var ODataV4Request = /** @class */ (function (_super) {
     ...
     * @param key
     */
    ODataV4Request.prototype.createResponse = function (data, bCreated, key, bDeleted) {
        if (bCreated === void 0) { bCreated = false; }
        if (key === void 0) { key = undefined; }
        if (bDeleted === void 0) { bDeleted = false; }
        var response = new simpleHttpResponse_1.SimpleResponse();
    ...
    ODataV4Request.prototype.toJSON = function (data) {
        ...
        if (Array.isArray(data)) {
            ...
            var result = {
                '@odata.context': "" + outContext,
                '@odata.metadataEtag': "" + this.metadata.getETag()
            };
