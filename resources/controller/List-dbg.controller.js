sap.ui.define([
    ...
    return BaseController.extend("wos.zint.pendingsto.controller.List", {
        ...
        onSearch: function (oEvent) {
            ...
            if (sQuery) {
                this._oListFilterState.aSearch = [new Filter("GenFilter", FilterOperator.Contains, sQuery)];
            } else {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "wos.zint.pendingsto.view.ViewSettingsDialog",
                    controller: this
